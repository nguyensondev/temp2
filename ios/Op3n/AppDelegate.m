...
{
  if ([[FBSDKApplicationDelegate sharedInstance] application:app openURL:url options:options] || [RNGoogleSignin application:app openURL:url options:options] || [[Twitter sharedInstance] application:app openURL:url options:options]) {
    return YES;
  }
