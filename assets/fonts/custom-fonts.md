# Instructions for adding custom fonts to Op3n app:

## For Expo Projects

You're lucky. Most of the work is done for you. Just download the `TTF` or `OTF` files you want to use, place them in `./src/theme/fonts/` and load them in the `index.ts` file in that same directory.

Op3n integrated `expo-fonts` according to [this guide](https://docs.expo.io/versions/latest/sdk/font/).
